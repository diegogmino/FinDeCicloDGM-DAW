...
public class DatabaseWebSecurity extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
    	web.ignoring().antMatchers(HttpMethod.POST, "/usuarios/guardar").antMatchers(HttpMethod.POST, "/usuarios/nuevoPedido/**").antMatchers(HttpMethod.POST, "/usuarios/mailContacto");
	}
