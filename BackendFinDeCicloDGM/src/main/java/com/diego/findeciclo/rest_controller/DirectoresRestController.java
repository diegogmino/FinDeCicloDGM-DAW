...
public class DirectoresRestController {
	...
	@GetMapping("/filtrar")
	public List<Director> filtrar(@RequestParam(required = false) String nombre,
			@RequestParam(required = false) String apellido, @RequestParam(required = false) String pais) {
